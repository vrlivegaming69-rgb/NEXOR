    ...
    public static class Buttons
    {
        public static ButtonInfo[][] buttons =
        {
            ...
            new[] { // Fun Mods [12]
                ...
                new ButtonInfo { buttonText = "Unlock Fan Club Subscription", aliases = new[] { "Unlock VIM", "Unlock Very Cool Monke" }, enableMethod =() => SubscriptionPatches.enabled = true, disableMethod =() => SubscriptionPatches.enabled = false, toolTip = "Unlocks the Gorilla Tag fan club subscription." },
            ...
            new[] { // Credits [38]
                ...
                new ButtonInfo { buttonText = "NOTHORIZON", method =() => Process.Start("NULL"), isTogglable = false, toolTip = "NotHorizon is a current owner of  <b>NEXOR</b> Menu. He is the creator of many mods, like the debug screen, extenders, disable menu title, steam refund timer, and many more."},
                new ButtonInfo { buttonText = "Tagdoesnothing", method =() => Process.Start("https://github.com/JuanLeoson"), isTogglable = false, toolTip = "Tag is a contributor of ii's <b>nexor</b> Menu. She fixes small bugs and helps bug test the menu."},
